...
const Footer = () => {
  ...
  const footerLinks = {
    ...
    services: [
      { name: "Parts Catalog", href: "#products" },
      { name: "Inventory", href: "#" },
          ...
          <div className="col-span-2">
            <a href="#home" className="flex items-center gap-3 mb-6">
              ...
              <div className="flex flex-col">
                <span className="font-display text-xl tracking-wider">ASHEL'S</span>
                <span className="text-xs text-muted-foreground -mt-1">AUTOSPARE</span>
              </div>
            </a>
            <p className="text-muted-foreground text-sm mb-6 max-w-xs">
              Your trusted partner for quality automotive spare parts. 
              Serving the industry with excellence since 2009.
            </p>
      ...
      <div className="border-t border-border">
        <div className="container-custom py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Ashel's Autospare. All rights reserved.
          </p>
          <Button
            variant="outline"
            size="icon"
